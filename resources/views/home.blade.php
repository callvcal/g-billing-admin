...
<head>
    ...
    <title>EatPlanet - Great Food Make Great Mood!</title>
  ...
  -->
    ...
    <header class="header" data-header>
        <div class="container">
            ...
            <h1>
                <a href="#" class="logo">Eatplan8<span class="span"></span></a>
            </h1>
      ...
      -->
            ...
            <section class="hero" id="home" style="#">
                <div class="hero-image">
                    <img src="{{ asset('img/hero-bg.jpg') }}" alt="Background Image">
                </div>
                ...
                <div class="container">
                    ...
                    <div class="hero-content">
                        ...
                        <p class="hero-subtitle" style="color: #ff5722;">EAT SLEEP REPEAT</p>

                        <h2 class="h1 hero-title" style="color: white;">A CULINARY JOURNEY AWAITS!</h2>
                    ...
                    <figure class="hero-banner">
                        ...
                        <!--<img src="{{ asset('img/hero-banner.png') }}" width="700" height="637" loading="lazy"-->
                    ...
                    <ul class="promo-list has-scrollbar">
                        ...
                        <li class="promo-item">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Indian</h3>

                                <p class="card-text">
                                    Experience a symphony of spices and flavors with authentic Indian cuisine, a
                                    culinary masterpiece.
                                </p>

                                <img src=" {{ asset('img/promo-1.png') }}" width="300" height="300"
                        ...
                        <li class="promo-item">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Chinese</h3>

                                <p class="card-text">
                                    Indulge in a tantalizing journey of savory delights with the rich diversity of
                                    Chinese cuisine.
                                </p>

                                <img src="{{ asset('img/promo-2.png') }}" width="300" height="300"
                                    loading="lazy" alt="chinese" class="w-100 card-banner">
                        ...
                        <li class="promo-item">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Continental</h3>

                                <p class="card-text">
                                    Explore a world of flavors with Continental cuisine, a delicious fusion of global
                                    culinary influences.
                                </p>

                                <img src="{{ asset('img/promo-3.png') }}" width="300" height="300"
                        ...
                        <li class="promo-item">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Shakes & Beverages </h3>

                                <p class="card-text">
                                    Quench your thirst and tantalize your taste buds with our refreshing shakes and
                                    delightful beverages.
                                </p>

                                <img src="{{ asset('img/promo-4.png') }}" width="300" height="300"
                        ...
                        <li class="promo-item">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Desserts & Cake</h3>

                                <p class="card-text">
                                    Indulge in decadent delights with our heavenly desserts and exquisite cakes,
                                    sweetening every moment.
                                </p>

                                <img src="{{ asset('img/promo-5.png') }}" width="300" height="300"
            ...
            <section class="section section-divider gray about" id="about">
                <div class="container">
                    ...
                    <div class="about-banner">
                        <img src="{{ asset('img/about-banner.png') }}" width="509" height="459" loading="lazy"
                            alt="Burger with Drinks" class="w-100 about-img">

                        <img src="{{ asset('img/sale-shape-red.png') }}" width="216" height="226"
                    ...
                    <div class="about-content">
                        ...
                        <h2 class="h2 section-title">
                            Lets try
                            <span class="span">in Patel Nagar Patna!</span>
                        </h2>

                        <p class="section-text">
                            At EATPLAN8, taste, service, and hygiene converge to redefi ne your dining experience. In
                            the heart of PATEL NAGAR, we stand out amidst competition, off ering unparalleled culinary
                            delights coupled with exceptional service. Our commitment to taste is evident in every dish
                            we serve, meticulously crafted to tantalize your palate and leave you craving for more.
                            Moreover, we prioritize hygiene with utmost care, ensuring a pristine environment for your
                            dining pleasure. we not only aim to satisfy your hunger but also to exceed your
                            expectations, making each visit memorable.
                            From vibrant salads to succulent grilled meats and fl avorful vegetarian options, each dish
                            is crafted with fresh, high-quality ingredients at our restaurant. Whether it's traditional
                            Indian cuisine or globally-inspired creations, we ensure a balanced culinary experience that
                            delights taste buds and promotes well-being.
                        </p>
                ...
                <div class="container">
                    ...
                    <div class="cta-content">
                        ...
                        <h2 class="h2 section-title" style=" color: #333; margin-bottom: 10px;">
                            Eatplan8 Serves Excellent

                            <span class="span" style="color: #ff5722;">Quality of Meals!</span>
                        </h2>

                        <p class="section-text" style=" color: #666;">

                            At our establishment, we cater to the most discerning palates, off ering an
                            array of culinary masterpieces. From exquisite flavors to impeccable presentation,
                            we ensure an unparalleled dining experience that exceeds expectations at every visit
                    ...
                    <figure class="cta-banner">
                        <img src="{{ asset('img/cta-banner1.png') }}" width="600" height="520" loading="lazy"
                            alt="Burger" class="w-100 cta-img">
                        <!--
            <img src="{{ asset('img/sale-shape.png') }}" width="216" height="226" loading="lazy"
              alt="get up to 50% off now" class="abs-img scale-up-anim"> -->
                    </figure>
