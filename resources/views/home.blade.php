...
Celebrate at Eatplan8 Restro & Lounge! Book our versatile party hall for birthdays, anniversaries, corporate events, and buffet parties. Enjoy delicious food and impeccable service. Contact us at 9102424888
</p>
            ...
            <section class="section section-divider gray about" id="about">
                <div class="container">
                    ...
                    <div class="about-content">
                        ...
                        At EATPLAN8 in PATEL NAGAR, we blend taste, service,
                         and hygiene to redefine dining. Our dishes, crafted with
                          high-quality ingredients, tantalize your palate and exceed expectations. From vibrant salads to succulent grilled meats and flavorful vegetarian options, we offer a balanced menu in a pristine, memorable dining environment.
                        </p>
      ...
      -->
            ...
            <section class="section section-divider white cta"
                ...
                <div class="container">
                    ...
                    <figure class="cta-banner">
                        <img src="{{ asset('img/cta-banner1.png') }}" width="500" height="380" loading="lazy"
